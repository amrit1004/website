                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                    <div>
                        ...
                        <p className="text-white/50 mt-4 max-w-lg">
                            Moments captured from our events, championships, and training sessions.
                        </p>
                    </div>
                    <Link href="/gallery">
                                ...
                                >
                                    <div className="aspect-[16/10] rounded-2xl overflow-hidden">
                                        ...
                                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl flex items-end">
                                            <p className="text-white text-base font-medium p-6 translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                                {image.caption}
                                            </p>
                                        </div>
                                    </div>
